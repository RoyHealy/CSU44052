...
int main(void)
{
	...
	for (int x = -100; x <= 100; x += 40) {
		for(int z = -100; z<=100; z+=40) {
			int height = 4*(2+std::rand()%8);
			b.initialize(glm::vec3(x, height/2, z), glm::vec3(4*(1+std::rand()%4), height, 4*(1+std::rand()%4)));
